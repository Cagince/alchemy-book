...
import { CrucibleBook } from '../book/CrucibleBook';
...
class ThreeWrapper extends Component {
    ...
    componentDidMount() {
        ...
        loader.load('/alchemists_table.gltf', (gltf) => {
    ...
    render() {
        ...
        return (
            <div>
                ...
                {this.state.displaySpellBook &&
                    <div className="book-modalWrapper" >
                        <button className="close-button" onClick={() => this.setState({ displaySpellBook: false })}>close</button>
                        <CrucibleBook />

                    </div>
                }

                {this.state.displayFAQ&&
                    <div className="book-modalWrapper" >
                        <button className="close-button" onClick={() => this.setState({ displayFAQ: false })}>close</button>
                        <Book />
